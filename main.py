...
# #CONNECT TO DB
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL1') or 'sqlite:///blog.db'
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            new_user.password = generate_password_hash(form.password.data, 'pbkdf2:sha256', salt_length=8)
